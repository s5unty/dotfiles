...
nmap <buffer> <F8> :w ~/hacking/du1ab.one/posts/<C-R>=Filename()<CR>
nmap <buffer> <F9> :!cd ~/hacking/du1ab.one/posts; git add '<C-R>=Filename()<CR>'; git ci -m '+ <C-R>=Title(3, 7)<CR>'; git push
