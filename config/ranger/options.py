...
def colorscheme_overlay(context, fg, bg, attr):
	...
	if context.marked:
		attr = color.bold
		fg, bg = color.black, color.white # To highlight the main column!

	if context.selected:
		fg, bg = color.yellow, color.black # To highlight the main column!

	return fg, bg, attr

# The above function was just an example, let's set it back to None
colorscheme_overlay = colorscheme_overlay
