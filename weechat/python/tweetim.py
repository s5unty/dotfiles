# coding=utf-8 
#
# Formats tweet.im\'s bot messages. Derived from fauno identica.py-0.4.2
# http://www.weechat.org/scripts/source/stable/identica.py/
#
# NOTE x_twitter 是我自定义的 tweet.im 机器人名称，默认是 YOUR@twitter.tweet.im
#      - re.sub("^x_twitter", "[^^^]", the_string)
#
...
SCRIPT_VERSION = "0.4.2-1"
SCRIPT_LICENSE = "GPL3"
SCRIPT_DESC    = "Formats tweet.im\'s bot messages. Derived from fauno identica.py-0.4.2"
...
settings = {
        ...
        'me'                      : '^(?P<update>\w+)(?P<separator>\W+?)(?P<nickname>\w+): \/me (?P<dent>.+)$',
