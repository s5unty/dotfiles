...
"
"       For C Source
"       let MRU_Include_Files = '\.c$\|\.cpp$\|\.cc$\|\.h$\|\.hpp$'  
"
...
" Files to include from the MRU list
...
function! s:MRU_AddFile(acmd_bufnr)
    ...
    if g:MRU_Include_Files != ''
        " Do add only files matching the pattern specified in the
        " MRU_Include_Files to the MRU list
