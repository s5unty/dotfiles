...
try:
    ...
    formatter = get_formatter_by_name('html', style='tango')
...
def _convert_with_pandoc(mdwn, inputfmt='markdown_github', outputfmt='html5',
...
def convert_markdown_to_html(mdwn):
    ...
    if body:
        ...
        html = _convert_with_pandoc(body, standalone=True)
